...
/*   Updated: 2024/12/05 16:26:21 by flverge          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	headings(1);
	v_printf = printf("%u", __INT_MAX__);
	bn();
	headings(2);
	v_ftprintf = ft_printf("%u", __INT_MAX__);
	bn();
	...
	headings(1);
	v_printf = printf("%i", __INT_MAX__);
	bn();
	headings(2);
	v_ftprintf = ft_printf("%i", __INT_MAX__);
	...
	headings(1);
	v_printf = printf("%x", __INT_MAX__);
	bn();
	headings(2);
	v_ftprintf = ft_printf("%x", __INT_MAX__);
